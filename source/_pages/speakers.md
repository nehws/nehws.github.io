...
**Talk title: A Scalable Framework for Hardware Security Verification**
...
<div style="text-align: justify;">
[![](../images/ryan_kastner.png){: style="width: 250px; float: left;
margin: 5px"}](https://kastner.ucsd.edu/ryan/)
...
margin: 5px"} **G. Edward Suh** is a Senior Director of Research, and leads a group in security 
...
### **Sharad Malik** ### {#sharad-malik}
**Princeton University**

![](../images/Sharad_malik.jpeg){: style="width: 230px; float: left;
margin: 5px"} **Sharad Malik** (F’02) received the B.Tech. degree in electrical engineering from the Indian Institute of Technology Delhi, New Delhi, India, in 1985, and the M.S. and Ph.D. degrees in computer science from the University of California at Berkeley, Berkeley, CA, USA, in 1987 and 1990, respectively.

...
![](../images/tufts_hall.jpg){: style="width: 80%; display: block; margin: auto;"}
...
<div id="tufts-map" style="width: 100%; height: 500px; margin: 20px auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></div>

<script src="../js/tufts-map.js"></script>
